...
Example usage:
- `python raman.py Isopropyl_W7_2.csv --spectrum=processed_spectrum.csv --peaks=detected_peaks.csv`
- `python raman.py Coal_2_W10.csv --stdout=spectrum | some_command_reading_stdin`
- `generate_spectrometer_data | python raman.py --stdout=peaks`

Some other files are also runnable as standalone programs, either exposing a CLI to their functionality or running demos/tests. Most take `--help` as an option.
